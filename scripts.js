...
$(document).ready(function () {
	...
	function start(){
		$('body').html('<header><h1>Hangman<h1><h3>Worlds Best Dried Fruit<h3></header><div id="main"><div id="popUpBox"><div id="popUpText"></div></div><div id="lines"></div><div id="inputArea"><input type="text" id="guess"><input type="submit" id="enter"></div><div id="bottom"><div id="incorrectGuesses"><p>Incorrect Guesses: </p><p id="incGuessLetter"></p></div><div id="hangmanLives"><p>Life</p><div id="display"><p id="hangmanDisplay"></p></div></div></div></div><footer><h6>Ive had 3 coffees trying to code this</h6></footer>');
